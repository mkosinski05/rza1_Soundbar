...
#define DMA_CH_CONFIG_TABLE_NUM  (64U)
...
#define CHCFG_SET_TM           (0x00400000U)
...
typedef struct
{
    ...
    bool_t             next_dma_flag;     /* Setting Flag of Continuous DMA */
    ...
    bool_t             setup_flag;        /* indicate called DMA_Setup() flag */
    ...
    volatile uint32_t           *p_dma_dmars_reg;  /* DMARS Register */
} dma_info_ch_t;
