...
******************************************************************************/
static int32_t RIIC_CH1_REG8_Write(const uint8_t riic_addr, const uint32_t reg_addr, const uint8_t *reg_data)
{
