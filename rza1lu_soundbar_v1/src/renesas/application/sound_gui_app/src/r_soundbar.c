...
static void task_loop_sound_demo (void *parameters);
...
/***********************************************************************************************************************
 * Function Name: task_loop_sound_demo
...
/***********************************************************************************************************************
 End of function task_loop_sound_demo
 **********************************************************************************************************************/
...
static void play_recorded (FILE *p_in, FILE *p_out)
{
    ...
    else
    {
        ...
        if (DEVDRV_SUCCESS == res)
        {
            ...
            /* Create play task (to normalise calling task) */
            p_task = R_OS_CreateTask("rec sound", task_loop_sound_demo, p_out,
            R_OS_ABSTRACTION_PRV_SMALL_STACK_SIZE,
